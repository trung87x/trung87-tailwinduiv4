...
<div class="grid min-h-full grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1">
  <div class="relative flex">
    <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/home-page-02-edition-01.jpg" alt="" class="absolute inset-0 size-full object-cover">
  ...
  <div class="relative flex">
    <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/home-page-02-edition-02.jpg" alt="" class="absolute inset-0 size-full object-cover">
    <div class="relative flex w-full flex-col items-start justify-end bg-black/40 p-8 sm:p-12">
