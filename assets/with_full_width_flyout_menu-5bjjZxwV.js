const e=`<header class="relative isolate z-10 bg-white">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      <div>
        ...
        -->
        <div class="absolute inset-x-0 top-0 -z-10 bg-white pt-14 ring-1 shadow-lg ring-gray-900/5">
          ...
          <div class="space-y-2 py-6">
            <div class="-mx-3">
              ...
              <div class="mt-2 space-y-2" id="disclosure-1">
                ...
                <a href="#" class="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-semibold text-gray-900 hover:bg-gray-50">View all products</a>
              </div>
            </div>
