const t=`<div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-xl lg:max-w-4xl">
    ...
    <div class="mt-16 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
      ...
      <div class="lg:mt-6 lg:w-80 lg:flex-none">
        <img class="h-12 w-auto" src="https://tailwindui.com/plus-assets/img/logos/workcation-logo-indigo-600.svg" alt="">
        <figure class="mt-10">
