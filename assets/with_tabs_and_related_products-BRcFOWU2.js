    ...
    <div class="fixed inset-0 z-40 flex">
      ...
      <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
        ...
        <div class="mt-2">
          <div class="border-b border-gray-200">
            <div class="-mb-px flex space-x-8 px-4" aria-orientation="horizontal" role="tablist">
              ...
              <button id="tabs-1-tab-1" class="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900" aria-controls="tabs-1-panel-1" role="tab" type="button">Wireframe Kits</button>
              <!-- Selected: "border-indigo-600 text-indigo-600", Not Selected: "border-transparent text-gray-900" -->
              <button id="tabs-1-tab-2" class="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900" aria-controls="tabs-1-panel-2" role="tab" type="button">Icons</button>
            </div>
          </div>
          ...
          <div id="tabs-1-panel-1" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
            <div class="grid grid-cols-2 gap-x-4">
              <div class="group relative text-sm">
                <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-05-menu-03.jpg" alt="Pricing page screenshot with tiered plan options and comparison table on colorful blue and green background." class="aspect-square w-full rounded-lg bg-gray-100 object-cover group-hover:opacity-75">
              ...
              <div class="group relative text-sm">
                <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-05-menu-04.jpg" alt="Application screenshot with tiered navigation and account settings form on color red and purple background." class="aspect-square w-full rounded-lg bg-gray-100 object-cover group-hover:opacity-75">
                <a href="#" class="mt-6 block font-medium text-gray-900">
                  <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                  Bones
                </a>
            ...
            <div>
              <p id="wireframe-application-heading-mobile" class="font-medium text-gray-900">Application UI</p>
              <ul role="list" aria-labelledby="wireframe-application-heading-mobile" class="mt-6 flex flex-col space-y-6">
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Home Screens</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Detail Screens</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Settings Screens</a>
                </li>
              </ul>
            </div>
            <div>
              <p id="wireframe-marketing-heading-mobile" class="font-medium text-gray-900">Marketing</p>
              <ul role="list" aria-labelledby="wireframe-marketing-heading-mobile" class="mt-6 flex flex-col space-y-6">
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Landing Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Pricing Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Contact Pages</a>
                </li>
              </ul>
            </div>
            <div>
              <p id="wireframe-ecommerce-heading-mobile" class="font-medium text-gray-900">Ecommerce</p>
              <ul role="list" aria-labelledby="wireframe-ecommerce-heading-mobile" class="mt-6 flex flex-col space-y-6">
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Storefront Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Product Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Category Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Shopping Cart Pages</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Checkout Pages</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div id="tabs-1-panel-2" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-2" role="tabpanel" tabindex="0">
            <div class="grid grid-cols-2 gap-x-4">
              ...
              <div class="group relative text-sm">
                <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-05-menu-02.jpg" alt="Calendar user interface screenshot with icon buttons and orange-yellow theme." class="aspect-square w-full rounded-lg bg-gray-100 object-cover group-hover:opacity-75">
                <a href="#" class="mt-6 block font-medium text-gray-900">
                  <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                  Marketing Icon Pack
                </a>
            ...
            <div>
              <p id="icons-general-heading-mobile" class="font-medium text-gray-900">General Use</p>
              <ul role="list" aria-labelledby="icons-general-heading-mobile" class="mt-6 flex flex-col space-y-6">
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Heroicons Solid</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Heroicons Outline</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Line Illustrations</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Hero Illustrations</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Branded Illustrations</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Skeuomorphic Illustrations</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Hand Drawn Illustrations</a>
                </li>
              </ul>
            </div>
            <div>
              <p id="icons-application-heading-mobile" class="font-medium text-gray-900">Application UI</p>
              <ul role="list" aria-labelledby="icons-application-heading-mobile" class="mt-6 flex flex-col space-y-6">
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Outlined</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Solid</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Branded</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Small</a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-2 block p-2 text-gray-500">Illustrations</a>
                </li>
              </ul>
            </div>
            <div>
              <p id="icons-marketing-heading-mobile" class="font-medium text-gray-900">Marketing</p>
        ...
        <div class="space-y-6 border-t border-gray-200 px-4 py-6">
          <div class="flow-root">
            <a href="#" class="-m-2 block p-2 font-medium text-gray-900">UI Kits</a>
          </div>
          <div class="flow-root">
            <a href="#" class="-m-2 block p-2 font-medium text-gray-900">Themes</a>
          </div>
        </div>
            ...
            <div class="flex h-full space-x-8">
              <div class="flex">
                <div class="relative flex">
                  ...
                  <button type="button" class="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-gray-800" aria-expanded="false">Wireframe Kits</button>
                </div>
                    ...
                    <div class="mx-auto max-w-7xl px-8">
                      <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                        ...
                        <div class="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                          <div>
                            <p id="application-heading" class="font-medium text-gray-900">Application UI</p>
                            <ul role="list" aria-labelledby="application-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Home Screens</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Detail Screens</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Settings Screens</a>
                              </li>
                            </ul>
                          </div>
                          <div>
                            <p id="marketing-heading" class="font-medium text-gray-900">Marketing</p>
                            <ul role="list" aria-labelledby="marketing-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Landing Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Pricing Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Contact Pages</a>
                              </li>
                            </ul>
                          </div>
                          <div>
                            <p id="ecommerce-heading" class="font-medium text-gray-900">Ecommerce</p>
                            <ul role="list" aria-labelledby="ecommerce-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Storefront Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Product Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Category Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Shopping Cart Pages</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Checkout Pages</a>
                              </li>
                            </ul>
                          </div>
                        </div>
              ...
              <div class="flex">
                <div class="relative flex">
                  <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                  <button type="button" class="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-gray-800" aria-expanded="false">Icons</button>
                </div>
                  ...
                  <div class="relative bg-white">
                    <div class="mx-auto max-w-7xl px-8">
                      <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                        ...
                        <div class="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                          <div>
                            <p id="general-heading" class="font-medium text-gray-900">General Use</p>
                            <ul role="list" aria-labelledby="general-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Heroicons Solid</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Heroicons Outline</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Line Illustrations</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Hero Illustrations</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Branded Illustrations</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Skeuomorphic Illustrations</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Hand Drawn Illustrations</a>
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul role="list" aria-labelledby="application-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Outlined</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Solid</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Branded</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Small</a>
                              </li>
                              <li class="flex">
                                <a href="#" class="hover:text-gray-800">Illustrations</a>
                              </li>
                            </ul>
                          </div>
                          <div>
  ...
  <main class="mx-auto px-4 pt-14 pb-24 sm:px-6 sm:pt-16 sm:pb-32 lg:max-w-7xl lg:px-8">
    ...
    <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
      ...
      <div class="lg:col-span-4 lg:row-end-1">
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-05-product-01.jpg" alt="Sample of 30 icons with friendly and fun details in outline, filled, and brand color styles." class="aspect-4/3 w-full rounded-lg bg-gray-100 object-cover">
      </div>
      ...
      <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
          <button type="button" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden">Pay $220</button>
        ...
        <div>
          <div class="border-b border-gray-200">
            <div class="-mb-px flex space-x-8" aria-orientation="horizontal" role="tablist">
              ...
              <button id="tab-reviews" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-700 hover:border-gray-300 hover:text-gray-800" aria-controls="tab-panel-reviews" role="tab" type="button">Customer Reviews</button>
              <button id="tab-faq" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-700 hover:border-gray-300 hover:text-gray-800" aria-controls="tab-panel-faq" role="tab" type="button">FAQ</button>
              <button id="tab-license" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-700 hover:border-gray-300 hover:text-gray-800" aria-controls="tab-panel-license" role="tab" type="button">License</button>
            </div>
          </div>
    ...
    <div class="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
      ...
      <div class="mt-6 grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
        <div class="group relative">
          <div class="relative">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-05-related-product-01.jpg" alt="Payment application dashboard screenshot with transaction table, financial highlights, and main clients on colorful purple background." class="aspect-4/3 w-full rounded-lg bg-gray-100 object-cover">
