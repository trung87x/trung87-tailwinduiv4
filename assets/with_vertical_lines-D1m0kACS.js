      ...
      <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
        <table class="min-w-full divide-y divide-gray-300">
          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            <tr class="divide-x divide-gray-200">
              <td class="py-4 pr-4 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-0">Lindsay Walton</td>
              <td class="p-4 text-sm whitespace-nowrap text-gray-500">Front-end Developer</td>
              <td class="p-4 text-sm whitespace-nowrap text-gray-500">lindsay.walton@example.com</td>
              <td class="py-4 pr-4 pl-4 text-sm whitespace-nowrap text-gray-500 sm:pr-0">Member</td>
            </tr>
