const e=`<div class="relative z-10" role="dialog" aria-modal="true">
  ...
  <div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
    ...
    -->
    <div class="mx-auto max-w-xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white ring-1 shadow-2xl ring-black/5 transition-all">
      ...
      <ul class="max-h-80 transform-gpu scroll-py-10 scroll-pb-2 space-y-4 overflow-y-auto p-4 pb-2" id="options" role="listbox">
        <li>
          ...
          <ul class="-mx-4 mt-2 text-sm text-gray-700">
            ...
            <li class="group flex cursor-default items-center px-4 py-2 select-none" id="option-1" role="option" tabindex="-1">
              <!-- Active: "text-white forced-colors:text-[Highlight]", Not Active: "text-gray-400" -->
              <svg class="size-6 flex-none text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
        ...
        <li>
          ...
          <ul class="-mx-4 mt-2 text-sm text-gray-700">
            <!-- Active: "bg-indigo-600 text-white outline-hidden" -->
            <li class="group flex cursor-default items-center px-4 py-2 select-none" id="option-2" role="option" tabindex="-1">
      ...
      <div class="flex flex-wrap items-center bg-gray-50 px-4 py-2.5 text-xs text-gray-700">Type <kbd class="mx-1 flex size-5 items-center justify-center rounded-sm border border-gray-400 bg-white font-semibold text-gray-900 sm:mx-2">#</kbd> <span class="sm:hidden">for projects,</span><span class="hidden sm:inline">to access projects,</span> <kbd class="mx-1 flex size-5 items-center justify-center rounded-sm border border-gray-400 bg-white font-semibold text-gray-900 sm:mx-2">&gt;</kbd> for users, and <kbd class="mx-1 flex size-5 items-center justify-center rounded-sm border border-gray-400 bg-white font-semibold text-gray-900 sm:mx-2">?</kbd> for help.</div>
    </div>
  </div>
</div>
`;export{e as default};
