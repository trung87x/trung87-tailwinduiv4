const s=`<main class="bg-white px-4 pt-16 pb-24 sm:px-6 sm:pt-24 lg:px-8 lg:py-32">
  <div class="mx-auto max-w-3xl">
    ...
    <section aria-labelledby="order-heading" class="mt-10 border-t border-gray-200">
      ...
      <div class="flex space-x-6 border-b border-gray-200 py-10">
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-05-product-01.jpg" alt="Glass bottle with black plastic pour top and mesh insert." class="size-20 flex-none rounded-lg bg-gray-100 object-cover sm:size-40">
