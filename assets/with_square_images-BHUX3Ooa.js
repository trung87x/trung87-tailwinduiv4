  ...
  <div class="mx-auto max-w-2xl px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
    ...
    <div class="mt-11 grid grid-cols-1 items-start gap-x-6 gap-y-16 sm:mt-16 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
      <div class="flex flex-col-reverse">
        ...
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-08-detail-01.jpg" alt="Green cardstock box containing white, beige, and brown cards." class="aspect-square w-full rounded-lg bg-gray-100 object-cover">
      </div>
      <div class="flex flex-col-reverse">
        <div class="mt-6">
        ...
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-08-detail-02.jpg" alt="Green cardstock box open with 50 cards inside." class="aspect-square w-full rounded-lg bg-gray-100 object-cover">
      </div>
      <div class="flex flex-col-reverse">
        <div class="mt-6">
        ...
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-08-detail-03.jpg" alt="Detail of white today card, beige next card, and brown someday card with dot grid." class="aspect-square w-full rounded-lg bg-gray-100 object-cover">
      </div>
      <div class="flex flex-col-reverse">
        <div class="mt-6">
        ...
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-08-detail-04.jpg" alt="Stack of three green cardstock boxes with 3 hole cutouts showing cards inside." class="aspect-square w-full rounded-lg bg-gray-100 object-cover">
      </div>
    </div>
  </div>
</div>
