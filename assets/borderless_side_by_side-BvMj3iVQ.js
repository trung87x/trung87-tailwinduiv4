const t=`<div class="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
  <div class="md:pr-14">
    ...
    <div class="mt-2 grid grid-cols-7 text-sm">
      <div class="py-2">
        ...
        -->
        <button type="button" class="mx-auto flex size-8 items-center justify-center rounded-full text-gray-400 hover:bg-gray-200">
      ...
      <div class="py-2">
        <button type="button" class="mx-auto flex size-8 items-center justify-center rounded-full text-gray-900 hover:bg-gray-200">
      ...
      <div class="border-t border-gray-200 py-2">
        <button type="button" class="mx-auto flex size-8 items-center justify-center rounded-full font-semibold text-indigo-600 hover:bg-gray-200">
      ...
      <div class="border-t border-gray-200 py-2">
        <button type="button" class="mx-auto flex size-8 items-center justify-center rounded-full bg-gray-900 font-semibold text-white">
  ...
  <section class="mt-12 md:mt-0 md:pl-14">
    ...
    <ol class="mt-4 flex flex-col gap-y-1 text-sm/6 text-gray-500">
      <li class="group flex items-center gap-x-4 rounded-xl px-4 py-2 focus-within:bg-gray-100 hover:bg-gray-100">
        ...
        <div class="relative opacity-0 group-hover:opacity-100 focus-within:opacity-100">
          <div>
          ...
          -->
          <div class="absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-white ring-1 shadow-lg ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-0-button" tabindex="-1">
