const n=`<span class="inline-flex size-6 items-center justify-center rounded-full bg-gray-500">
...
<span class="inline-flex size-12 items-center justify-center rounded-full bg-gray-500">
