const t=`<div class="px-4 sm:px-6 lg:px-8">
      ...
      <tbody>
        <tr>
          ...
          <td class="relative py-3.5 pr-4 pl-3 text-right text-sm font-medium sm:pr-6">
            <button type="button" class="inline-flex items-center rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-white">Select<span class="sr-only">, Hobby</span></button>
          </td>
        </tr>
        <tr>
          <td class="relative border-t border-transparent py-4 pr-3 pl-4 text-sm sm:pl-6">
            ...
            <div class="absolute -top-px right-0 left-6 h-px bg-gray-200"></div>
          </td>
          <td class="hidden border-t border-gray-200 px-3 py-3.5 text-sm text-gray-500 lg:table-cell">8 GB RAM</td>
          <td class="hidden border-t border-gray-200 px-3 py-3.5 text-sm text-gray-500 lg:table-cell">6 CPUs</td>
          <td class="hidden border-t border-gray-200 px-3 py-3.5 text-sm text-gray-500 lg:table-cell">256 GB SSD disk</td>
          ...
          <td class="relative border-t border-transparent py-3.5 pr-4 pl-3 text-right text-sm font-medium sm:pr-6">
            ...
            <div class="absolute -top-px right-6 left-0 h-px bg-gray-200"></div>
          </td>
        </tr>
