const e=`<header class="absolute inset-x-0 top-0 z-50 flex h-16 border-b border-gray-900/10">
    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div class="mx-auto flex max-w-2xl items-center justify-between gap-x-8 lg:mx-0 lg:max-w-none">
        <div class="flex items-center gap-x-6">
          <img src="https://tailwindui.com/plus-assets/img/logos/48x48/tuple.svg" alt="" class="size-16 flex-none rounded-full ring-1 ring-gray-900/10">
          <h1>
        ...
        <div class="flex items-center gap-x-4 sm:gap-x-6">
          ...
          <div class="relative sm:hidden">
            ...
            -->
            <div class="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 ring-1 shadow-lg ring-gray-900/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="more-menu-button" tabindex="-1">
        ...
        <table class="mt-16 w-full text-left text-sm/6 whitespace-nowrap">
          ...
          <tbody>
            <tr class="border-b border-gray-100">
              ...
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">20.0</td>
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">$100.00</td>
              <td class="py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums">$2,000.00</td>
            </tr>
            <tr class="border-b border-gray-100">
              <td class="max-w-0 px-0 py-5 align-top">
              ...
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">52.0</td>
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">$100.00</td>
              <td class="py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums">$5,200.00</td>
            </tr>
            <tr class="border-b border-gray-100">
              <td class="max-w-0 px-0 py-5 align-top">
              ...
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">12.0</td>
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">$100.00</td>
              <td class="py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums">$1,200.00</td>
            </tr>
            <tr class="border-b border-gray-100">
              <td class="max-w-0 px-0 py-5 align-top">
              ...
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">4.0</td>
              <td class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell">$100.00</td>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td class="pt-4 pr-0 pb-0 pl-8 text-right font-semibold text-gray-900 tabular-nums">$10,560.00</td>
            </tr>
          </tfoot>
        </table>
      </div>
        ...
        <div class="mt-6 flex gap-x-3">
          ...
          <form action="#" class="relative flex-auto">
            <div class="overflow-hidden rounded-lg pb-12 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
              ...
              <textarea rows="2" name="comment" id="comment" class="block w-full resize-none bg-transparent px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Add your comment..."></textarea>
            </div>
                    ...
                    <div class="relative">
                      ...
                      <!--
                        ...
                        Leaving: "transition ease-in duration-100"
                          ...
                          To: "opacity-0"
                      -->
                      <ul class="absolute bottom-10 z-10 -ml-6 w-60 rounded-lg bg-white py-3 text-base ring-1 shadow-sm ring-black/5 focus:outline-hidden sm:ml-auto sm:w-64 sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-5">
                        <!--
                          Select option, manage highlight styles based on mouseenter/mouseleave and keyboard navigation.

                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-0" role="option">
                          <div class="flex items-center">
                        ...
                        <!--
                          ...
                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-1" role="option">
                          <div class="flex items-center">
                        ...
                        <!--
                          ...
                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-2" role="option">
                          <div class="flex items-center">
                        ...
                        <!--
                          ...
                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-3" role="option">
                          <div class="flex items-center">
                        ...
                        <!--
                          ...
                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-4" role="option">
                          <div class="flex items-center">
                        ...
                        <!--
                          ...
                          Highlighted: "bg-gray-100", Not Highlighted: "bg-white"
                        -->
                        <li class="relative cursor-default bg-white px-3 py-2 select-none" id="listbox-option-5" role="option">
                          <div class="flex items-center">
