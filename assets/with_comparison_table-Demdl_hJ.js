  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
      <section class="p-8">
        ...
        <a href="#" aria-describedby="tier-starter" class="mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold text-indigo-600 ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
      ...
      <section class="rounded-xl bg-gray-400/5 p-8 ring-1 ring-gray-200 ring-inset">
        <h3 id="tier-growth" class="text-sm/6 font-semibold text-gray-900">Growth</h3>
        <p class="mt-2 flex items-baseline gap-x-1 text-gray-900">
          <span class="text-4xl font-semibold">$49</span>
          <span class="text-sm font-semibold">/month</span>
        </p>
        <a href="#" aria-describedby="tier-growth" class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
        <ul role="list" class="mt-10 space-y-4 text-sm/6 text-gray-900">
          <li>
            <ul role="list" class="space-y-4">
              <li class="flex gap-x-3">
      ...
      <section class="p-8">
        ...
        <a href="#" aria-describedby="tier-scale" class="mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold text-indigo-600 ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
        <ul role="list" class="mt-10 space-y-4 text-sm/6 text-gray-900">
          <li>
            <ul role="list" class="space-y-4">
              <li class="flex gap-x-3">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" class="px-6 pt-6 xl:px-8 xl:pt-8">
                <div class="text-sm/7 font-semibold text-gray-900">Starter</div>
              </th>
              <th scope="col" class="px-6 pt-6 xl:px-8 xl:pt-8">
                <div class="text-sm/7 font-semibold text-gray-900">Growth</div>
              </th>
              <th scope="col" class="px-6 pt-6 xl:px-8 xl:pt-8">
                <div class="text-sm/7 font-semibold text-gray-900">Scale</div>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td class="px-6 pt-2 xl:px-8">
                ...
                <a href="#" class="mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold text-indigo-600 ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
              </td>
              <td class="px-6 pt-2 xl:px-8">
                <div class="flex items-baseline gap-x-1 text-gray-900">
                  <span class="text-4xl font-semibold">$49</span>
                ...
                <a href="#" class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
              </td>
              <td class="px-6 pt-2 xl:px-8">
                <div class="flex items-baseline gap-x-1 text-gray-900">
                  <span class="text-4xl font-semibold">$99</span>
            ...
            <tr>
              <th scope="colgroup" colspan="4" class="pt-8 pb-4 text-sm/6 font-semibold text-gray-900">
                Features
            ...
            <tr>
              ...
              <td class="px-6 py-4 xl:px-8">
                <div class="text-center text-sm/6 text-gray-500">1</div>
              </td>
              <td class="px-6 py-4 xl:px-8">
                <div class="text-center text-sm/6 text-gray-500">3</div>
              </td>
              <td class="px-6 py-4 xl:px-8">
                <div class="text-center text-sm/6 text-gray-500">Unlimited</div>
              </td>
            </tr>
            <tr>
              <th scope="row" class="py-4 text-sm/6 font-normal text-gray-900">
              ...
              <td class="px-6 py-4 xl:px-8">
                <div class="text-center text-sm/6 text-gray-500">20</div>
              </td>
              <td class="px-6 py-4 xl:px-8">
                <div class="text-center text-sm/6 text-gray-500">Unlimited</div>
              </td>
            ...
            <tr>
              <th scope="colgroup" colspan="4" class="pt-16 pb-4 text-sm/6 font-semibold text-gray-900">
                Reporting
                <div class="absolute inset-x-8 mt-4 h-px bg-gray-900/10"></div>
              </th>
            </tr>
