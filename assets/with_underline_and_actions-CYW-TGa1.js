  ...
  <div class="min-w-0 flex-1">
    <form action="#">
      <div class="border-b border-gray-200 pb-px focus-within:border-b-2 focus-within:border-indigo-600 focus-within:pb-0">
        ...
        <textarea rows="3" name="comment" id="comment" class="block w-full resize-none text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Add your comment..."></textarea>
      </div>
              ...
              <div class="relative">
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-100"
                    ...
                    To: "opacity-0"
                -->
                <ul class="absolute z-10 -ml-6 w-60 rounded-lg bg-white py-3 text-base shadow-sm outline-1 outline-black/5 sm:ml-auto sm:w-64 sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-5">
                  <!--
                    Select option, manage highlight styles based on mouseenter/mouseleave and keyboard navigation.

                    Highlighted: "relative outline-hidden bg-gray-100", Not Highlighted: "bg-white"
                  -->
