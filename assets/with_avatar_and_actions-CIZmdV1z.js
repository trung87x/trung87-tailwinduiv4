const e=`<div class="flex items-start space-x-4">
  <div class="shrink-0">
  ...
  <div class="min-w-0 flex-1">
    <form action="#" class="relative">
      <div class="rounded-lg bg-white outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
        ...
        <textarea rows="3" name="comment" id="comment" class="block w-full resize-none bg-transparent px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Add your comment..."></textarea>
              ...
              <div class="relative">
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-100"
                    ...
                    To: "opacity-0"
                -->
                <ul class="absolute z-10 mt-1 -ml-6 w-60 rounded-lg bg-white py-3 text-base shadow-sm outline-1 outline-black/5 sm:ml-auto sm:w-64 sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-5">
                  <!--
                    Select option, manage highlight styles based on mouseenter/mouseleave and keyboard navigation.

                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-0" role="option">
                    <div class="flex items-center">
                  ...
                  <!--
                    ...
                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-1" role="option">
                    <div class="flex items-center">
                  ...
                  <!--
                    ...
                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-2" role="option">
                    <div class="flex items-center">
                  ...
                  <!--
                    ...
                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-3" role="option">
                    <div class="flex items-center">
                  ...
                  <!--
                    ...
                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-4" role="option">
                    <div class="flex items-center">
                  ...
                  <!--
                    ...
                    Highlighted: "bg-gray-100 relative outline-hidden", Not Highlighted: "bg-white"
                  -->
                  <li class="cursor-default bg-white px-3 py-2 select-none" id="listbox-option-5" role="option">
                    <div class="flex items-center">
