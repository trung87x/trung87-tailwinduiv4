  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <div class="rounded-3xl p-8 ring-1 ring-gray-200 xl:p-10">
        ...
        <a href="#" aria-describedby="tier-freelancer" class="mt-6 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
      ...
      <div class="rounded-3xl p-8 ring-1 ring-gray-200 xl:p-10">
        <h3 id="tier-startup" class="text-lg/8 font-semibold text-gray-900">Startup</h3>
      ...
      <div class="rounded-3xl bg-gray-900 p-8 ring-1 ring-gray-900 xl:p-10">
        <h3 id="tier-enterprise" class="text-lg/8 font-semibold text-white">Enterprise</h3>
        <p class="mt-4 text-sm/6 text-gray-300">Dedicated support and infrastructure for your company.</p>
        <p class="mt-6 flex items-baseline gap-x-1">
          <span class="text-4xl font-semibold tracking-tight text-white">Custom</span>
        </p>
        <a href="#" aria-describedby="tier-enterprise" class="mt-6 block rounded-md bg-white/10 px-3 py-2 text-center text-sm/6 font-semibold text-white hover:bg-white/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Contact sales</a>
