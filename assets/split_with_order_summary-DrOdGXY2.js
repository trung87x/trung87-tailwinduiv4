const e=`<div class="bg-white">
  ...
  <div class="fixed top-0 right-0 hidden h-full w-1/2 bg-indigo-900 lg:block" aria-hidden="true"></div>
  ...
  <header class="relative mx-auto max-w-7xl bg-indigo-900 py-6 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:bg-transparent lg:px-8 lg:pt-16 lg:pb-10">
    <div class="mx-auto flex max-w-2xl px-4 lg:w-full lg:max-w-lg lg:px-0">
      <a href="#">
        ...
        <img src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=300" alt="" class="h-8 w-auto lg:hidden">
        <img src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="" class="hidden h-8 w-auto lg:block">
      </a>
    </div>
  </header>
