        ...
        <nav aria-label="Progress" class="hidden sm:block">
          <ol role="list" class="flex space-x-4">
            <li class="flex items-center">
              <a href="#">Cart</a>
              <svg class="ml-4 size-5 text-gray-300" aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" data-slot="icon">
      ...
      <div class="mx-auto max-w-lg lg:max-w-none">
        ...
        <ul role="list" class="divide-y divide-gray-200 text-sm font-medium text-gray-900">
          <li class="flex items-start space-x-4 py-6">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/checkout-page-04-product-01.jpg" alt="Moss green canvas compact backpack with double top zipper, zipper front pouch, and matching carry handle and backpack straps." class="size-20 flex-none rounded-md object-cover">
