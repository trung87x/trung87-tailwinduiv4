    ...
    <div class="bg-white">
      <div class="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 sm:pt-24 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        ...
        <div class="mt-10 lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-04-featured-product-shot.jpg" alt="Light green canvas bag with black straps, handle, front zipper pouch, and drawstring top." class="aspect-square w-full rounded-lg object-cover">
        </div>
    ...
    <div class="mx-auto max-w-2xl px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
      ...
      <section aria-labelledby="details-heading">
        ...
        <div class="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg" alt="Drawstring top with elastic loop closure and textured interior padding." class="aspect-3/2 w-full rounded-lg object-cover">
          ...
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-02.jpg" alt="Front zipper pouch with included key ring." class="aspect-3/2 w-full rounded-lg object-cover">
      ...
      <section aria-labelledby="policy-heading" class="mt-16 lg:mt-24">
        ...
        <div class="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8">
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-delivery-light.svg" alt="" class="h-24 w-auto">
          ...
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-chat-light.svg" alt="" class="h-24 w-auto">
          ...
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-fast-checkout-light.svg" alt="" class="h-24 w-auto">
          ...
          <div>
            <img src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-gift-card-light.svg" alt="" class="h-24 w-auto">
