                  ...
                  <div class="flex">
                    ...
                    <!--
                      ...
                      Leaving: "transition ease-in duration-150"
                        ...
                        To: "opacity-0"
                    -->
                    <div class="absolute inset-x-0 top-full -translate-y-px transform bg-white text-sm text-gray-500">
    ...
    <section aria-labelledby="products-heading" class="mt-6">
      ...
      <div class="space-y-8">
        <div class="border-t border-b border-gray-200 bg-white shadow-xs sm:rounded-lg sm:border">
          <div class="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
            <div class="sm:flex lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-03-product-01.jpg" alt="Insulated bottle with white base and black snap lid." class="aspect-square w-full shrink-0 rounded-lg object-cover sm:size-40">
        ...
        <div class="border-t border-b border-gray-200 bg-white shadow-xs sm:rounded-lg sm:border">
          <div class="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
            <div class="sm:flex lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-03-product-02.jpg" alt="Arm modeling wristwatch with black leather band, white watch face, thin watch hands, and fine time markings." class="aspect-square w-full shrink-0 rounded-lg object-cover sm:size-40">
