    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 px-4 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
      <div class="sm:flex">
        <div class="sm:shrink-0">
          <div class="flow-root">
            <img class="h-24 w-28" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-delivery-light.svg" alt="">
          </div>
        </div>
      ...
      <div class="sm:flex">
        <div class="sm:shrink-0">
          <div class="flow-root">
            <img class="h-24 w-28" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-warranty-light.svg" alt="">
          </div>
        </div>
        <div class="mt-3 sm:mt-0 sm:ml-3">
      ...
      <div class="sm:flex">
        <div class="sm:shrink-0">
          <div class="flow-root">
            <img class="h-24 w-28" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-returns-light.svg" alt="">
          </div>
        </div>
        <div class="mt-3 sm:mt-0 sm:ml-3">
      ...
      <div class="sm:flex">
        <div class="sm:shrink-0">
          <div class="flow-root">
            <img class="h-24 w-28" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-planet-light.svg" alt="">
          </div>
        </div>
        <div class="mt-3 sm:mt-0 sm:ml-3">
