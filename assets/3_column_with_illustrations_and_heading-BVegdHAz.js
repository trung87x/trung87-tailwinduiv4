        ...
        <div class="mx-auto mt-12 grid max-w-sm grid-cols-1 gap-x-8 gap-y-10 sm:max-w-none lg:grid-cols-3">
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
            <div class="sm:shrink-0">
              <div class="flow-root">
                <img class="mx-auto size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-shipping-simple.svg" alt="">
              </div>
            </div>
          ...
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
            <div class="sm:shrink-0">
              <div class="flow-root">
                <img class="mx-auto size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-warranty-simple.svg" alt="">
              </div>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
          ...
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
            <div class="sm:shrink-0">
              <div class="flow-root">
                <img class="mx-auto size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-exchange-simple.svg" alt="">
              </div>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
