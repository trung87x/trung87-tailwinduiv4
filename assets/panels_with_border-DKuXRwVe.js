const e=`<div class="lg:border-t lg:border-b lg:border-gray-200">
    ...
    <ol role="list" class="overflow-hidden rounded-md lg:flex lg:rounded-none lg:border-r lg:border-l lg:border-gray-200">
      <li class="relative overflow-hidden lg:flex-1">
        <div class="overflow-hidden rounded-t-md border border-b-0 border-gray-200 lg:border-0">
          <!-- Completed Step -->
          <a href="#" class="group">
            <span class="absolute top-0 left-0 h-full w-1 bg-transparent group-hover:bg-gray-200 lg:top-auto lg:bottom-0 lg:h-1 lg:w-full" aria-hidden="true"></span>
      ...
      <li class="relative overflow-hidden lg:flex-1">
        <div class="overflow-hidden border border-gray-200 lg:border-0">
          ...
          <a href="#" aria-current="step">
            <span class="absolute top-0 left-0 h-full w-1 bg-indigo-600 lg:top-auto lg:bottom-0 lg:h-1 lg:w-full" aria-hidden="true"></span>
