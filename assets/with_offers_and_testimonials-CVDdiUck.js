    ...
    <div class="flex flex-col border-b border-gray-200 lg:border-0">
      ...
      <div class="relative">
        ...
        <div class="h-48 w-full sm:h-64 lg:absolute lg:top-0 lg:right-0 lg:h-full lg:w-1/2">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/home-page-02-hero-half-width.jpg" alt="" class="size-full object-cover">
        </div>
      </div>
    </div>
            ...
            <ul role="list" class="mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 lg:grid lg:grid-cols-4 lg:gap-x-8 lg:space-x-0">
              <li class="inline-flex w-64 flex-col text-center lg:w-auto">
                <div class="group relative">
                  <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/home-page-02-product-01.jpg" alt="Black machined steel pen with hexagonal grip and small white logo at top." class="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75">
                  <div class="mt-6">
                ...
                <ul role="list" class="mt-auto flex items-center justify-center space-x-3 pt-6">
                  <li class="size-4 rounded-full border border-black/10" style="background-color: #111827">
                    <span class="sr-only">Black</span>
                  </li>
                  <li class="size-4 rounded-full border border-black/10" style="background-color: #fde68a">
                    <span class="sr-only">Brass</span>
                  </li>
                  <li class="size-4 rounded-full border border-black/10" style="background-color: #e5e7eb">
    ...
    <div class="relative overflow-hidden">
      ...
      <div aria-hidden="true" class="absolute inset-0">
        <div class="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/home-page-02-sale-full-width.jpg" alt="" class="size-full object-cover">
        </div>
        <div class="absolute inset-0 bg-white/75"></div>
        <div class="absolute inset-0 bg-linear-to-t from-white via-white"></div>
      </div>
          ...
          <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
            <blockquote class="sm:flex lg:block">
              ...
              <div class="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                ...
                <cite class="mt-4 block font-semibold text-gray-900 not-italic">Sarah Peters, New Orleans</cite>
              </div>
            </blockquote>
            <blockquote class="sm:flex lg:block">
              <svg width="24" height="18" viewBox="0 0 24 18" aria-hidden="true" class="shrink-0 text-gray-300">
              ...
              <div class="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                ...
                <cite class="mt-4 block font-semibold text-gray-900 not-italic">Kelly McPherson, Chicago</cite>
              </div>
            </blockquote>
            <blockquote class="sm:flex lg:block">
              <svg width="24" height="18" viewBox="0 0 24 18" aria-hidden="true" class="shrink-0 text-gray-300">
              ...
              <div class="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                ...
                <cite class="mt-4 block font-semibold text-gray-900 not-italic">Chris Paul, Phoenix</cite>
              </div>
            </blockquote>
          </div>
        </div>
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
          ...
          <div class="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
            <div class="absolute inset-0 overflow-hidden rounded-lg">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt="" class="size-full object-cover saturate-0 filter">
        ...
        <div class="mt-4 flex items-center justify-center md:mt-0">
          ...
          <div class="ml-6 border-l border-gray-200 pl-6">
            <a href="#" class="flex items-center text-gray-500 hover:text-gray-600">
              <img src="https://tailwindui.com/plus-assets/img/flags/flag-canada.svg" alt="" class="h-auto w-5 shrink-0">
