              ...
              <div class="flex">
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-150"
                    ...
                    To: "opacity-0"
                -->
                <div class="absolute inset-x-0 top-full z-20">
    ...
    <section aria-labelledby="products-heading" class="mx-auto max-w-7xl overflow-hidden sm:px-6 lg:px-8">
      ...
      <div class="-mx-px grid grid-cols-2 border-l border-gray-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
        <div class="group relative border-r border-b border-gray-200 p-4 sm:p-6">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/category-page-05-image-card-01.jpg" alt="TODO" class="aspect-square rounded-lg bg-gray-200 object-cover group-hover:opacity-75">
        ...
        <div class="group relative border-r border-b border-gray-200 p-4 sm:p-6">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/category-page-05-image-card-02.jpg" alt="TODO" class="aspect-square rounded-lg bg-gray-200 object-cover group-hover:opacity-75">
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
        ...
        <div class="group relative border-r border-b border-gray-200 p-4 sm:p-6">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/category-page-05-image-card-03.jpg" alt="TODO" class="aspect-square rounded-lg bg-gray-200 object-cover group-hover:opacity-75">
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
        ...
        <div class="group relative border-r border-b border-gray-200 p-4 sm:p-6">
          <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/category-page-05-image-card-04.jpg" alt="TODO" class="aspect-square rounded-lg bg-gray-200 object-cover group-hover:opacity-75">
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
