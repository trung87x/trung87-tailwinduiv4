      ...
      <div class="mt-10 space-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16">
        <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:items-center lg:gap-x-8">
          ...
          <div class="flex-auto lg:col-span-7 xl:col-span-8">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-04-detail-03.jpg" alt="Printed photo of bag being tossed into the sky on top of grass." class="aspect-5/2 w-full rounded-lg bg-gray-100 object-cover">
          </div>
        </div>
        <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:items-center lg:gap-x-8">
          <div class="mt-6 lg:col-span-5 lg:mt-0 xl:col-span-4">
          ...
          <div class="flex-auto lg:col-span-7 xl:col-span-8">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-04-detail-01.jpg" alt="Double stitched black canvas hook loop." class="aspect-5/2 w-full rounded-lg bg-gray-100 object-cover">
          </div>
        </div>
        <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:items-center lg:gap-x-8">
          <div class="mt-6 lg:col-span-5 lg:mt-0 xl:col-span-4">
          ...
          <div class="flex-auto lg:col-span-7 xl:col-span-8">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-04-detail-02.jpg" alt="Black canvas body with chrome zipper and key ring." class="aspect-5/2 w-full rounded-lg bg-gray-100 object-cover">
          </div>
        </div>
      </div>
    </div>
