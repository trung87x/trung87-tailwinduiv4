...
<main class="relative lg:min-h-full">
  <div class="h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
    <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-06-hero.jpg" alt="TODO" class="size-full object-cover">
  </div>
      ...
      <div class="lg:col-start-2">
        ...
        <ul role="list" class="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-gray-500">
          <li class="flex space-x-6 py-6">
            <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-06-product-01.jpg" alt="Model wearing men&#039;s charcoal basic tee in large." class="size-24 flex-none rounded-md bg-gray-100 object-cover">
