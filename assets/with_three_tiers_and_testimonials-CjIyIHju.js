      ...
      <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <div class="rounded-3xl p-8 ring-1 ring-white/10 xl:p-10">
          <div class="flex items-center justify-between gap-x-4">
            <h2 id="tier-freelancer" class="text-lg/8 font-semibold text-white">Freelancer</h2>
          </div>
          <p class="mt-4 text-sm/6 text-gray-300">The essentials to provide your best work for clients.</p>
          <p class="mt-6 flex items-baseline gap-x-1">
            <!-- Price, update based on frequency toggle state -->
            <span class="text-4xl font-semibold tracking-tight text-white">$19</span>
        ...
        <div class="rounded-3xl bg-white/5 p-8 ring-2 ring-indigo-500 xl:p-10">
          <div class="flex items-center justify-between gap-x-4">
            <h2 id="tier-startup" class="text-lg/8 font-semibold text-white">Startup</h2>
        ...
        <div class="rounded-3xl p-8 ring-1 ring-white/10 xl:p-10">
          <div class="flex items-center justify-between gap-x-4">
            <h2 id="tier-enterprise" class="text-lg/8 font-semibold text-white">Enterprise</h2>
          </div>
    ...
    <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
      ...
      <div class="mt-20">
        <dl class="space-y-16 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:space-y-0 sm:gap-y-16 lg:gap-x-10">
          <div>
            <dt class="text-base/7 font-semibold text-white">What&#039;s the best thing about Switzerland?</dt>
            <dd class="mt-2 text-base/7 text-gray-300">I don&#039;t know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.</dd>
          </div>
