const e=`<div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
    <div class="relative rounded-3xl bg-white p-8 ring-1 shadow-2xl ring-gray-900/10 sm:p-10">
      <h3 id="tier-personal" class="text-base/7 font-semibold text-indigo-600">Personal</h3>
