      ...
      <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        <div class="relative flex h-16 items-center justify-between lg:border-b lg:border-indigo-400/25">
          <div class="flex items-center px-2 lg:px-0">
            <div class="shrink-0">
              <img class="block size-8" src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=300" alt="Your Company">
            </div>
          ...
          <div class="hidden lg:ml-4 lg:block">
            <div class="flex items-center">
              ...
              <div class="relative ml-3 shrink-0">
                <div>
                  <button type="button" class="relative flex rounded-full bg-indigo-600 text-sm text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    <span class="absolute -inset-1.5"></span>
