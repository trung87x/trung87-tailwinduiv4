      ...
      <div class="mt-4">
        <div class="-mx-4 flex overflow-x-auto sm:mx-0">
          <div class="flex-auto border-b border-gray-200 px-4 sm:px-0">
            <div class="-mb-px flex space-x-10" aria-orientation="horizontal" role="tablist">
              ...
              <button id="features-tab-1" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700" aria-controls="features-panel-1" role="tab" type="button">Design</button>
              <button id="features-tab-2" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700" aria-controls="features-panel-2" role="tab" type="button">Material</button>
              <button id="features-tab-3" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700" aria-controls="features-panel-3" role="tab" type="button">Considerations</button>
              <button id="features-tab-4" class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700" aria-controls="features-panel-4" role="tab" type="button">Included</button>
            </div>
          </div>
        </div>
        ...
        <div id="features-panel-1" class="space-y-16 pt-10 lg:pt-16" aria-labelledby="features-tab-1" role="tabpanel" tabindex="0">
          <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-06-detail-01.jpg" alt="Maple organizer base with slots, supporting white polycarbonate trays of various sizes." class="aspect-2/1 w-full rounded-lg bg-gray-100 object-cover sm:aspect-5/2">
            </div>
          </div>
        </div>
        <div id="features-panel-2" class="space-y-16 pt-10 lg:pt-16" aria-labelledby="features-tab-2" role="tabpanel" tabindex="0">
          <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-06-detail-02.jpg" alt="Walnut organizer base with pen, sticky note, phone, and bin trays, next to modular drink coaster attachment." class="aspect-2/1 w-full rounded-lg bg-gray-100 object-cover sm:aspect-5/2">
            </div>
          </div>
        </div>
        <div id="features-panel-3" class="space-y-16 pt-10 lg:pt-16" aria-labelledby="features-tab-3" role="tabpanel" tabindex="0">
          <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-06-detail-03.jpg" alt="Walnut organizer base with white polycarbonate trays in the kitchen with various kitchen utensils." class="aspect-2/1 w-full rounded-lg bg-gray-100 object-cover sm:aspect-5/2">
            </div>
          </div>
        </div>
        <div id="features-panel-4" class="space-y-16 pt-10 lg:pt-16" aria-labelledby="features-tab-4" role="tabpanel" tabindex="0">
          <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-7">
              <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/product-feature-06-detail-04.jpg" alt="Walnut organizer system on black leather desk mat on top of white desk." class="aspect-2/1 w-full rounded-lg bg-gray-100 object-cover sm:aspect-5/2">
            </div>
          </div>
        </div>
      </div>
