const e=`<div class="relative border-b border-gray-200 pb-5 sm:pb-0">
  ...
  <div class="mt-4">
    ...
    <div class="hidden sm:block">
      <nav class="-mb-px flex space-x-8">
        ...
        <a href="#" class="border-b-2 border-transparent px-1 pb-4 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700">Applied</a>
        <a href="#" class="border-b-2 border-transparent px-1 pb-4 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700">Phone Screening</a>
        <a href="#" class="border-b-2 border-indigo-500 px-1 pb-4 text-sm font-medium whitespace-nowrap text-indigo-600" aria-current="page">Interview</a>
        <a href="#" class="border-b-2 border-transparent px-1 pb-4 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700">Offer</a>
        <a href="#" class="border-b-2 border-transparent px-1 pb-4 text-sm font-medium whitespace-nowrap text-gray-500 hover:border-gray-300 hover:text-gray-700">Hired</a>
      </nav>
    </div>
  </div>
</div>
