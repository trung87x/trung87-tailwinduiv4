      ...
      <div class="relative flex items-center justify-center py-5 lg:justify-between">
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
          ...
          <div class="relative ml-4 shrink-0">
            <div>
              <button type="button" class="relative flex rounded-full bg-white text-sm ring-2 ring-white/20 focus:ring-white focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <span class="absolute -inset-1.5"></span>
            ...
            -->
            <div class="absolute -right-2 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
        ...
        <div class="absolute right-0 shrink-0 lg:hidden">
          <!-- Mobile menu button -->
          <button type="button" class="relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-indigo-200 hover:bg-white/10 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden" aria-expanded="false">
        ...
        <div class="grid grid-cols-3 items-center gap-8">
          <div class="col-span-2">
            <nav class="flex space-x-4">
              ...
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-white/10" aria-current="page">Home</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-white/10">Profile</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-white/10">Resources</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-white/10">Company Directory</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-white/10">Openings</a>
            </nav>
          </div>
        ...
        <div class="divide-y divide-gray-200 rounded-lg bg-white ring-1 shadow-lg ring-black/5">
          <div class="pt-3 pb-2">
            <div class="flex items-center justify-between px-4">
              ...
              <div class="-mr-2">
                <button type="button" class="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:ring-2 focus:ring-indigo-500 focus:outline-hidden focus:ring-inset">
                  <span class="absolute -inset-0.5"></span>
