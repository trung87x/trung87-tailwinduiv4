const e=`<div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
      <li>
        <ul role="list" class="-mx-2 space-y-1">
          ...
          <li>
            <div>
              ...
              <ul class="mt-1 px-2" id="sub-menu-1">
                <li>
                  <a href="#" class="block rounded-md py-2 pr-2 pl-9 text-sm/6 text-gray-700 hover:bg-gray-50">Engineering</a>
                </li>
                <li>
                  <a href="#" class="block rounded-md py-2 pr-2 pl-9 text-sm/6 text-gray-700 hover:bg-gray-50">Human Resources</a>
                </li>
                <li>
                  <a href="#" class="block rounded-md py-2 pr-2 pl-9 text-sm/6 text-gray-700 hover:bg-gray-50">Customer Success</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li>
            <a href="#" class="block rounded-md py-2 pr-2 pl-10 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50">Calendar</a>
          </li>
          <li>
            <a href="#" class="block rounded-md py-2 pr-2 pl-10 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50">Documents</a>
          </li>
          <li>
            <a href="#" class="block rounded-md py-2 pr-2 pl-10 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50">Reports</a>
          </li>
        </ul>
      </li>
