const n=`<!-- Global notification live region, render this permanently at the end of the document -->
  ...
  <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
    <!--
      ...
      Leaving: "transition ease-in duration-100"
        ...
        To: "opacity-0"
    -->
    <div class="pointer-events-auto w-full max-w-sm rounded-lg bg-white ring-1 shadow-lg ring-black/5">
      <div class="p-4">
