  ...
  <div class="mx-auto max-w-7xl py-24 sm:px-2 sm:py-32 lg:px-4">
    <div class="mx-auto max-w-2xl px-4 lg:max-w-none">
      <div class="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
        ...
        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/incentives-07-hero.jpg" alt="" class="aspect-3/2 w-full rounded-lg bg-gray-100 object-cover">
      </div>
      <div class="mt-16 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
        <div class="sm:flex lg:block">
          <div class="sm:shrink-0">
            <img class="size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-shipping-simple.svg" alt="">
          </div>
        ...
        <div class="sm:flex lg:block">
          <div class="sm:shrink-0">
            <img class="size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-warranty-simple.svg" alt="">
          </div>
          <div class="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
        ...
        <div class="sm:flex lg:block">
          <div class="sm:shrink-0">
            <img class="size-16" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-exchange-simple.svg" alt="">
          </div>
          <div class="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
