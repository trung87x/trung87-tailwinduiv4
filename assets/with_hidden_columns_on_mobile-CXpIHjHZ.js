  ...
  <div class="-mx-4 mt-8 sm:-mx-0">
    <table class="min-w-full divide-y divide-gray-300">
      ...
      <tbody class="divide-y divide-gray-200 bg-white">
        <tr>
          <td class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-0">Lindsay Walton</td>
          <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-500 sm:table-cell">Front-end Developer</td>
          <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-500 lg:table-cell">lindsay.walton@example.com</td>
