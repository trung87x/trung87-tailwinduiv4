          ...
          <section aria-labelledby="cart-heading">
            ...
            <ul role="list" class="divide-y divide-gray-200 border-t border-b border-gray-200">
              <li class="flex py-6 sm:py-10">
                <div class="shrink-0">
                  <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/shopping-cart-page-01-product-03.jpg" alt="Insulated bottle with white base and black snap lid." class="size-24 rounded-lg object-cover sm:size-32">
                </div>
                  ...
                  <div>
                    ...
                    <div class="mt-4 flex items-center sm:absolute sm:top-0 sm:left-1/2 sm:mt-0 sm:block">
                      <div class="inline-grid w-full max-w-16 grid-cols-1">
                        <select id="quantity-0" name="quantity-0" aria-label="Quantity, Nomad Tumbler" class="col-start-1 row-start-1 appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              ...
              <li class="flex py-6 sm:py-10">
                <div class="shrink-0">
                  <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/shopping-cart-page-01-product-01.jpg" alt="Front of men&#039;s Basic Tee in sienna." class="size-24 rounded-lg object-cover sm:size-32">
                </div>
                ...
                <div class="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                  <div>
                    ...
                    <div class="mt-4 flex items-center sm:absolute sm:top-0 sm:left-1/2 sm:mt-0 sm:block">
                      <div class="inline-grid w-full max-w-16 grid-cols-1">
                        <select id="quantity-1" name="quantity-1" aria-label="Quantity, Basic Tee" class="col-start-1 row-start-1 appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                          <option value="4">4</option>
        ...
        <div class="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-0">
          <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
            <div class="md:shrink-0">
              <div class="flow-root">
                <img class="mx-auto -my-1 h-24 w-auto" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-returns-light.svg" alt="">
              </div>
            </div>
          ...
          <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
            <div class="md:shrink-0">
              <div class="flow-root">
                <img class="mx-auto -my-1 h-24 w-auto" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-calendar-light.svg" alt="">
              </div>
            </div>
            <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
          ...
          <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
            <div class="md:shrink-0">
              <div class="flow-root">
                <img class="mx-auto -my-1 h-24 w-auto" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-gift-card-light.svg" alt="">
              </div>
            </div>
            <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
          ...
          <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
            <div class="md:shrink-0">
              <div class="flow-root">
                <img class="mx-auto -my-1 h-24 w-auto" src="https://tailwindui.com/plus-assets/img/ecommerce/icons/icon-planet-light.svg" alt="">
              </div>
            </div>
            <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
