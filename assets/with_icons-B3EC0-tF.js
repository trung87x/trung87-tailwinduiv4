const e=`<div class="relative z-10" role="dialog" aria-modal="true">
  ...
  <div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
    ...
    -->
    <div class="mx-auto max-w-2xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white ring-1 shadow-2xl ring-black/5 transition-all">
      ...
      <ul class="max-h-80 scroll-py-2 divide-y divide-gray-100 overflow-y-auto">
        <li class="p-2">
          <h2 class="mt-4 mb-2 px-3 text-xs font-semibold text-gray-500">Recent searches</h2>
